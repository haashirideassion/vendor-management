...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "group/card skeuo-surface flex flex-col gap-6 overflow-hidden rounded-4xl border border-white/55 py-6 text-sm text-card-foreground ring-1 ring-border/60 has-[>img:first-child]:pt-0 data-[size=sm]:gap-4 data-[size=sm]:py-4 dark:border-white/10 dark:ring-foreground/10 *:[img:first-child]:rounded-t-4xl *:[img:last-child]:rounded-b-4xl",
        className
      )}
      {...props}
    />
